...
NAME = 'errcorect'
KEYWORDS = 'error analysis correcting'
DESC = 'Analyze and try to correct errors in Python code'
...
def get_version(default='0.1'):
    ...
    package = __import__('errcorect')

    return getattr(package, '__version__', default)
